 ...
 * - Cada atributo deve possuir UM método de imput (setter) e UM método de output (getter)
...
public class Aluno {
	...
	public Aluno (int rm, String nome, String email) {
		//nome = "Vazio"; // aqui ou na declaração acima do parametro
		//email = "nomedoemail@domínio.com(br)";
		super();
		this.rm = rm;
		this.nome = nome;
		this.email= email;
